# 第6课｜没人教它，AI 是怎么学会说话的

> 公众号版 **第 6 课**（标题带编号；篇名从第 7 课起进标题，本课用摘要补「训练原理篇」）。对应仓库 [04 · 训练与微调](../04-training-and-finetuning.md) 的前半段：权重、loss、梯度下降、预训练。面向零基础读者，约 1400 字。
