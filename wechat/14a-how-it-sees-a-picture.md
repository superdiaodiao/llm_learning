...
你在豆包里拍一道题，它给你讲解；在 ChatGPT 里发一张菜单照片，它帮你翻译；在 Kimi 里传一张截图，问"图里那个人拿的是什么"，它答对了。
...
2021 年 OpenAI 的 CLIP 把两套坐标对齐了，后来几乎所有看图和画图的模型都踩在它上面。做法很朴素：从网上抓四亿张带说明文字的图，每次拿一批，比如一百张图配一百句话。**配对的那一对，把两串数字拉近；不配对的九十九对，推远。**没有人打标签，图和它旁边的说明文字就是全部的老师。
...
- 在豆包、ChatGPT 或 Kimi 里发一张有很多人的合影，问它"几个人"。多试两张，看它在什么样的图上数错。
